  ...
  return (
    <main className="page">
      ...
      <section className="card">
        ...
        <ul className="list">
          <li>
            <strong>Produção (auth.agottani.dev):</strong> abra{" "}
          ...
          <li>
            <strong>
              Local (<code>localhost</code>):
            </strong>{" "}
            mesmo fluxo da query — o cookie fica apenas na origem local (sem
            atributo Domain), porque o navegador não permite{" "}
            <code>.agottani.dev</code> partindo de outro registrable domain.
          </li>
          <li>
            <strong>Pages em github.io:</strong> usar{" "}
            <code>Domain=.agottani.dev</code> a partir do host github.io pode
            ser rejeitado; use o deploy no domínio customizado para validar
